...
class SignUpViewBody extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SignUpViewBody> createState() => _SignUpState();
}

class _SignUpState extends ConsumerState<SignUpViewBody> {
                ...
                children: [
                  TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () => GoRouter.of(context).pushReplacement(AppRouter.kSignInView),
                  ),
                ],
              ),
            ),
